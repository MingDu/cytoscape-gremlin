...
*/
    ...
    public CompletableFuture<Boolean> connectAsync(ConnectionParameter connectionParameter) {
        ...
        ioRegisters.add("org.janusgraph.graphdb.tinkerpop.JanusGraphIoRegistry");
        ioRegisters.add("org.apache.tinkerpop.gremlin.tinkergraph.structure.TinkerIoRegistryV3d0");
        configMap.put(org.apache.tinkerpop.gremlin.driver.ser.AbstractGryoMessageSerializerV3d0.TOKEN_IO_REGISTRIES, ioRegisters);
